...
*		- make the operation selectable through command line args
		...
		- make different versions of pad_image and generate_kernel since when being parallel, when a process encountered an error, process 0 should terminate all its children and exit.
*/
