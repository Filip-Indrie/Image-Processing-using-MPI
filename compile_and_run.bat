...
:: compile main
gcc -g main.c -I "c:\Program Files (x86)\Microsoft SDKs\MPI\Include" -L "c:\Program Files (x86)\Microsoft SDKs\MPI\Lib\x64" -o main.exe bmp_common.o bmp.o convolution.o image_processing.o -lmsmpi -fopenmp
